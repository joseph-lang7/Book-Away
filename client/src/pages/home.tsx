...
const Home = () => {
  ...
  return (
    <div className="container w-full h-[600px] p-0">
      <div className="bg-cover bg-center w-full h-full rounded-md shadow-xl flex flex-col justify-center relative">
        <img
          src="/home.jpg"
          alt="Home"
          className="w-full h-full object-cover absolute brightness-50"
        />
        <h2 className="text-5xl text-white max-w-[500px] pl-5 z-10 leading-[60px]">
          List your property on BookAway and open your door to rental income
        </h2>
        <Link
          to={isLoggedIn ? `/add-listing` : "/sign-in"}
          className="relative inline-flex items-center justify-center px-6 py-3 text-lg font-medium tracking-tighter text-white bg-gray-800 rounded-md group disabled:bg-gray-500 max-w-[200px] ml-5 mt-5"
        >
